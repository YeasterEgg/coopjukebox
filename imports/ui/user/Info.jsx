    ...
    return(
      <div className="info--container">
        <div className="info--text">
          ...
          <p>Any user, even if it&#39;s not registered to Spotify, will be able to influence your Spotify Playlist from the link you will see on your page, with structure &quot;democracy-jockey.herokuapp.com/NAME_OF_PLAYLIST&quot;. He will be able either vote a track or add a track to the pool list, once for every turn.</p>
